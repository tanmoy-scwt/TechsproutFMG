...
import { TrainerInfoSectionContent } from "../../types";
...
interface TrainerInfoSectionProps {
  content: TrainerInfoSectionContent;
}
interface Country {
  calling_code: string;
  code: string;
...
function TrainerInfoSection({ content }: TrainerInfoSectionProps) {
    ...
    if (isChecked == 1) {
      ...
      if (recaptchadata.success) {
        ...
        if (callingCode == "91") {
          ...
          const trainer = await ServerFetch(`/user/contact`, {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
          ...
          if (trainer?.status) {
            SuccessToast("Trainer will contact you soon.");
            reset();
            setIsOpen(false);
            setIsOtpOpen(false);
  ...
  return (
    <>
      <section className="section">
        <div className="container ti__info--container">
          <PreviewImage
            src={content.image}
            ...
            width={200}
            height={220}
            className="ti__info--img"
          />
          <div className="ti__info">
            <div className="ti__info--details">
              <h1 className="ex-title ti__name">{content.name}</h1>

              <p className="ti__profession">{content.profession}</p>

              <p className="ti__info--item-text">
                {"Ratings "}
                <span>
                  <RatingStar
              ...
              <DialogContent className="sm:max-w-[1094px] c-connected-card-modal">
                <div className="c-connected-card-modal__grid">
                  ...
                  <div className="c-connected-card-modal__col c-connected-card-modal__form-area">
                    ...
                    <form onSubmit={onSubmit} className="contactTrainer">
      ...
      <section className="container ti__about-section section">
        <h2 className="subtitle">{`About ${content.name}`}</h2>
        {/* <p className="ex-desc">{content.about}</p> */}
