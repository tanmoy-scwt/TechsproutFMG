            ...
            <div className="cdr__ratings--average-container">
               <div className="cdr__ratings--average">
                  ...
                  <Dialog open={isOpen} onOpenChange={setIsOpen}>
                     ...
                     <DialogContent className="sm:max-w-[800px] c-post-review-modal post_model">
                        <h2>Post Review</h2>
                        <form onSubmit={onSubmit}>
                              ...
                              <div className="c-input-area">
                                 ...
                                 <input
                                    ...
                                    {...register("phone", {
                                       ...
                                       pattern: {
                                          value: /^[0-9]{10}$/, // Adjust this regex for your use case
                              ...
                              <div className="c-input-area">
                                 ...
                                 <input
                                    ...
                                    {...register("email", {
                                       ...
                                       pattern: {
                                          value: /^[\w-\.]+@([\w-]+\.)+[\w-]{2,12}$/, // Adjust this regex for stricter email rules
                           ...
                           <div className="flex flex-row items-center c-post-review-modal__button-area">
                              ...
                              <div className="basis-1/4">
                                 ...
                                 <button
                                    id="post_review_btn"
                                    className="button__primary ml-auto"
                                    type="submit"
                                    disabled={isLoading}
                                 >
                                    {isLoading ? (
                                       <>
                                          <span>Post Review</span> <span className="loader"></span>
                                       </>
                                    ) : (
